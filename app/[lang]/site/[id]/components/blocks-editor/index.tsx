...
import BlocksRender from "@/app/[lang]/blocks-render"

import { generateRandomId } from "@/lib/generate-random-Id"
import BlockOptions from "../block-options"
import { useBuilderContext } from "../context"

interface BuilderBlocksEditorProps {
  template: any
...
const BuilderBlocksEditor: React.FC<BuilderBlocksEditorProps> = ({
  template,
  blockRef,
  index,
  parentLength,
...
export default React.memo(BuilderBlocksEditor)

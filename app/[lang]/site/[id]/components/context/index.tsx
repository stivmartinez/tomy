...
import blocks from "@/lib/blocks-list"
      ...
      children: [
        {
          ...
          tag: "div",
          type: "container",
          className: "w-full max-w-3xl mx-auto px-8 min-h-screen",
          children: [
            {
              id: "3",
              tag: "section",
              ...
              children: [
                {
                  type: "columns",
                  tag: "div",
                  className: "w-full flex flex-row min-h-[24px] gap-2",
                  content: "",
                  icon: {},
                  id: "520514",
                  parentId: "3",
                  children: [
                    {
                      type: "image",
                      tag: "img",
                      className: "w-40 block my-8",
                      content: "",
                      props: {
                        src: "https://www.notion.so/cdn-cgi/image/format=auto,width=640,quality=100/front-static/pages/home/docs-illo.png",
                        alt: "Example image",
                      },
                      icon: {},
                      selfClosing: true,
                  ...
                  children: [
                    {
                      type: "heading",
                      tag: "h1",
                      className: "text-2xl font-bold w-full tracking-tight",
                  ...
                  children: [
                    {
                      type: "paragraph",
                      tag: "p",
                      className: "text-md w-full text-gray-500 max-w-xl",
                      content:
                        "Making new pages, content and design are very easy with tomy, just tap in each block that you want to edit and customize. you can choose from starter components or search into the community blocks.",
                      icon: {},
                      id: "901527",
                      parentId: "38353",
                      children: [],
                  ...
                  children: [
                    {
                      type: "heading",
                      tag: "h1",
                      className: "text-xl font-semibold w-full tracking-tight",
                ...
                },
                {
                  type: "columns",
                  tag: "div",
                  className: "w-full flex flex-col min-h-[24px] gap-2 my-2",
                  content: "",
                  icon: {},
                  id: "808168",
                  parentId: "3",
                  children: [
                    {
                      type: "paragraph",
                      tag: "p",
                      className: "text-md w-full text-gray-500",
                      content:
                        "1. Add blocks clicking in the layers button at bottom bar.",
                      icon: {},
                      id: "684917",
                      parentId: "808168",
                      children: [],
                    },
                    {
                      ...
                      className: "text-md w-full text-gray-500",
                      content:
                        "2. Select a premade template from the marketplace.",
                      icon: {},
                      id: "298746",
                      parentId: "808168",
                      children: [],
